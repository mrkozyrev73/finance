const CACHE='moi-dohody-v108',FILES=['./polish.css?v=8','./','./index.html','./app.css?v=12','./supabase-sync.js?v=13','./manifest.webmanifest','./apple-touch-icon.png','./icon-192.png','./icon-512.png'];
